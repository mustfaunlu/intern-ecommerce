...
class CartListAdapter(private val onItemLongClicked: (UserCartUiData) -> Unit) : ListAdapter<UserCartUiData, CartListAdapter.ShoppingListViewHolder>(
    ...
    inner class ShoppingListViewHolder(private val binding: CartItemBinding) : RecyclerView.ViewHolder(binding.root) {
