...
class SigInViewModel @Inject constructor(
    ...
    private val _firebaseLoginState = MutableLiveData<ScreenState<FirebaseUserUiData>>()
    val firebaseLoginState: LiveData<ScreenState<FirebaseUserUiData>> get() = _firebaseLoginState
